...
::: {.callout-warning}
Prerequisite: [watsonx Discovery Software Requirement](/environment.html#rag-document-search)
:::
## Build setup
<div
  style={{
...
Navigate to this [github](https://github.ibm.com/skol-assets/watson<span style="color:#2c62f5;">x</span>-RAG-w-watson<span style="color:#2c62f5;">x</span>discovery-method2/) 
and download [this project file](https://github.ibm.com/skol-assets/watson<span style="color:#2c62f5;">x</span>-RAG-w-watson<span style="color:#2c62f5;">x</span>discovery-method2/blob/main/project/WatsonStudioProjectTemplate.zip)
